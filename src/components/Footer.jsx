            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-8 lg:py-10">
                <div className="md:flex md:justify-between md:items-start">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-10 sm:grid-cols-3">
                        {/* Resources */}
                        <div>
                            <h2 className="mb-6 text-sm font-semibold uppercase tracking-wide text-gray-300">
                                Resources
                            </h2>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-400 font-medium space-y-3">
                                ...
                                <li>
                                    <a
                                        href="https://www.linkedin.com/in/nikhil-partap"
                                        target="_blank"
                                        rel="noreferrer"
                                        className="hover:text-cyan-400 transition-colors"
                                    >
                                ...
                                {/* <li>
                                    <Link href="www.instagram.com/nikhil_1245b/" className="hover:text-cyan-400 transition-colors">
                                        Instagram
                                    </Link>
                                </li> */}
                            </ul>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <Link
                            to="https://www.instagram.com/nikhil_1245b/"
                            className="text-gray-400 hover:text-cyan-400 transition-colors"
                        ...
                        <Link
                            to="https://github.com/nikhil-partap"
                            className="text-gray-400 hover:text-cyan-400 transition-colors"
                        ...
                        <Link
                            to="https://www.linkedin.com/in/nikhil-partap"
                            className="text-gray-400 hover:text-cyan-400 transition-colors"
